...
from application.client.add_allowed_redirect_url.add_allowed_url import (
    AddAllowedRedirectUrlCommandHandler,
)
from application.client.get_client.client_queries import (
...
from application.user.confirm_email.handler import ConfirmEmailHandler
from application.user.delete_account.handler import DeleteUserHandler

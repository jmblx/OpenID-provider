...
from src.application.email_notification.third_party_register_notify.handler import ThirdPartyEmailConfirmationHandler
...
class AppProvider(Provider):
    ...
    third_party_email_confirmation_handler = provide(ThirdPartyEmailConfirmationHandler, scope=Scope.REQUEST)

...
subject_email_routing = {
    "confirmation": {
        ...
        BACKEND_URL/EMAIL_CONFIRMATION_URL
    ...
    "reset_password": {
        ...
        BACKEND_URL/custom/reset-password/code
...
async def send_email(email: str, subject: str, **kwargs):
    ...
    logger.info(f"Sending email email {email}")
    ...
    try:
        ...
        logger.info(f"Email sent email {email}")
    except Exception as e:
        logger.error(f"Failed email send email email {email}: {e}")

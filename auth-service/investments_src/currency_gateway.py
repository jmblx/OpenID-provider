...
class CurrenciesGateway:
    ...
    async def get_currencies_for_date(self, date: str, currency_codes: list[str]) -> dict:
    ...
    async def get_currencies_for_last_days(self, days: int, currency_codes: list[str]) -> dict:

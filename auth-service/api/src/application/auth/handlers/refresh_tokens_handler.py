...
class RefreshTokensHandler:
    ...
    async def handle(self, refresh_token: RefreshToken, fingerprint: Fingerprint) -> tuple[AccessToken, RefreshToken]:
        return await self.auth_service.refresh_tokens(refresh_token=refresh_token, fingerprint=fingerprint)

...
async def refresh_token(refresh_token: FromDishka[RefreshToken], fingerprint: FromDishka[Fingerprint], handler: FromDishka[RefreshTokensHandler]) -> ORJSONResponse:
...
async def revoke_token(refresh_token: FromDishka[RefreshToken], handler: FromDishka[RevokeTokensHandler]) -> ORJSONResponse:
